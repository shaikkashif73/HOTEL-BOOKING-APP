...
//OLD CODE WHICH I WRITTEN AND THE ABOVE CODE WAS MODIFIED BY CHAT GPT
...
//         </div>
//         {/* CheckIn CheckOut Form    */}
//         <form className="flex flex-col md:flex-row items-center md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,1.5)] p-6 rounded-xl mx-auto mt-16 max-w-6xl">
//           <div className="flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10  text-gray-500  ">
//             <div className="flex flex-col">
